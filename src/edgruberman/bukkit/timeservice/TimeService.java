...
public final class TimeService extends JavaPlugin {
    ...
    public void onEnable() {
        this.reloadConfig();
        TimeService.messenger = new Messenger(this);
    ...
    public void reloadConfig() {
        ...
        if (version.compareTo(TimeService.MINIMUM_CONFIGURATION) >= 0) return;
